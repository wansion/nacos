...
public class HttpClient {
  ...
  public static void asyncHttpGet(
      String url,
      List<String> headers,
      Map<String, String> paramValues,
  ...
  public static void asyncHttpPost(
      String url,
      List<String> headers,
      Map<String, String> paramValues,
      AsyncCompletionHandler handler)
  ...
  public static void asyncHttpDelete(
      String url,
      List<String> headers,
      Map<String, String> paramValues,
      AsyncCompletionHandler handler)
  ...
  public static void asyncHttpPostLarge(
      String url, List<String> headers, String content, AsyncCompletionHandler handler)
      throws Exception {
    asyncHttpPostLarge(url, headers, content.getBytes(), handler);
  }

  public static void asyncHttpPostLarge(
      String url, List<String> headers, byte[] content, AsyncCompletionHandler handler)
      throws Exception {
  ...
  public static void asyncHttpDeleteLarge(
      String url, List<String> headers, String content, AsyncCompletionHandler handler)
      throws Exception {
  ...
  public static HttpResult httpPost(
      String url, List<String> headers, Map<String, String> paramValues, String encoding) {
    try {
  ...
  public static void asyncHttpPutLarge(
      String url, Map<String, String> headers, byte[] content, AsyncCompletionHandler handler)
      throws Exception {
  ...
  public static void asyncHttpGetLarge(
      String url, Map<String, String> headers, byte[] content, AsyncCompletionHandler handler)
      throws Exception {
  ...
  public static HttpResult httpGetLarge(String url, Map<String, String> headers, String content) {
    ...
    try {
      ...
      httpGetWithEntity.setEntity(
          new StringEntity(content, ContentType.create("application/json", "UTF-8")));
