...
public class CacheData {
  ...
  /**
   * Add listener if CacheData already set new content, Listener should init lastCallMd5 by
   * CacheData.md5
   *
  ...
  private void safeNotifyListener(
      final String dataId,
      final String group,
          ...
          public void run() {
            ...
            try {
              if (listener instanceof AbstractSharedListener) {
                ...
                LOGGER.info(
                    "[{}] [notify-context] dataId={}, group={}, md5={}", name, dataId, group, md5);
              }
              ...
              LOGGER.error(
                  "[{}] [notify-error] dataId={}, group={}, md5={}, listener={} errCode={} errMsg={}",
                  name,
                  dataId,
                  group,
                  md5,
    ...
    LOGGER.info(
        "[{}] [notify-listener] time cost={}ms in ClientWorker, dataId={}, group={}, md5={}, listener={} ",
        name,
        (finishNotify - startNotify),
        dataId,
        group,
        md5,
        listener);
  ...
  private String loadCacheContentFromDiskLocal(
      String name, String dataId, String group, String tenant) {
  ...
  public CacheData(
      ConfigFilterChainManager configFilterChainManager, String name, String dataId, String group) {
