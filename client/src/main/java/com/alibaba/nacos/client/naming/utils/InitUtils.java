...
public class InitUtils {
              ...
              new Callable<String>() {
                ...
                public String call() {
                  ...
                  LogUtils.NAMING_LOGGER.info(
                      "initializer namespace from System Property :" + namespace);
                  return namespace;
                }
              });
      ...
      tmpNamespace =
          TemplateUtils.stringEmptyAndThenExecute(
              ...
              new Callable<String>() {
                ...
                public String call() {
                  String namespace =
                      System.getenv(PropertyKeyConst.SystemEnv.ALIBABA_ALIWARE_NAMESPACE);
                  LogUtils.NAMING_LOGGER.info(
                      "initializer namespace from System Environment :" + namespace);
                  return namespace;
                }
              });
    }
  ...
  public static void initWebRootContext() {
    ...
    TemplateUtils.stringNotEmptyAndThenExecute(
        webContext,
        new Runnable() {
          @Override
          public void run() {
  ...
  public static String initEndpoint(final Properties properties) {
    ...
    if (isUseEndpointParsingRule) {
      ...
      endpointUrl =
          ParamUtil.parsingEndpointRule(properties.getProperty(PropertyKeyConst.ENDPOINT));
